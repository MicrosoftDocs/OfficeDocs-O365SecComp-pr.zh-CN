...
---
# <a name="support-for-validation-of-dkim-signed-messages"></a><span data-ttu-id="463f1-103">支持 DKIM 签名邮件验证</span><span class="sxs-lookup"><span data-stu-id="463f1-103">Support for validation of DKIM signed messages</span></span>
