...
> > [!TIP]
> 可选信息, 可帮助用户更成功地考虑在测试模式下启用 ASF 选项, 以便根据您的环境最大限度地阻止垃圾邮件。 对于特定 ASF 选项具有高垃圾邮件百分比的客户来说，我们建议您在部署他们到您的生产环境之前测试这些选项。 > 建议关注网络钓鱼的组织启用 " **SPF 记录: 硬失败**" 选项。 
  
下表介绍了每个高级垃圾邮件筛选选项。
  
||||
|:-----|:-----|:-----|
|**高级垃圾邮件筛选选项** <br/> |**Description** <br/> |**X 标头文本** <br/> |
