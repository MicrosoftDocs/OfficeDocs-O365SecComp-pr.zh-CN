...
3. 运行以下命令, 将 PST 文件上载到 Office 365。
    ...
    下表描述了各个参数及其所需值。 请注意, 在上一步中获取的信息在这些参数的值中使用。
