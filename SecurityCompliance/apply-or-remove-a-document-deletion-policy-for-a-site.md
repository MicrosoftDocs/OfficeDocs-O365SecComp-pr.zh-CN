...
如果将文档删除策略应用于已对列表或库使用内容类型策略或信息管理策略的网站, 则在文档删除策略生效时, 将忽略这些策略。如果忽略其他策略, 则会看到消息 "此网站上的内容使用文档删除策略"。
...
如果您的网站使用的是内容类型策略, 现在看到此消息, 则这些策略将不再有效。若要还原内容类型策略, 可以删除网站中的文档删除策略 (如前面所述) (如果有选择退出选项)。如果没有选项可供选择, 则文档删除策略是必需的, 您需要与组织中的合规性监察官联系。
...
如果您的网站使用信息管理策略且现在看到此消息, 则这些策略将不再有效。若要还原信息管理策略, 可以删除网站中的文档删除策略 (如前面所述) (如果有选择退出选项)。如果没有选项可供选择, 则文档删除策略是必需的, 您需要与组织中的合规性监察官联系。
