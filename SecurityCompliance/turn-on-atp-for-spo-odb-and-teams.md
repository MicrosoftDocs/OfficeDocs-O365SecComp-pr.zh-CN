...
1. 以全局管理员或 security 管理员程序中，转到[https://security.microsoft.com](https://security.microsoft.com)，并使用您的工作或学校帐户登录。
...
1. 在[Office 365 安全性&amp;合规性中心](https://security.microsoft.com)，选择**警报** \> **管理通知**。
