...
---
# <a name="eu-phone-number"></a>欧盟电话号码

Office 365 安全性的数据丢失防护 (DLP)&amp;合规性中心包括许多可供您可以使用 DLP 策略中的敏感信息类型。本主题介绍欧盟电话号码敏感信息类型。 
...
- 正则表达式`Regex_austria_eu_telephone_number_1`查找与模式匹配的内容。 
    
- 从关键字`Keywords_austria_eu_telephone_number`找到。 
    
在 300 个字符的相似度内，如果出现以下情况，DLP 策略 75% 确信它检测到这种类型的敏感信息：
  
- 正则表达式`Regex_austria_eu_telephone_number_2`查找与模式匹配的内容。 
...
- 正则表达式`Regex_belgium_eu_telephone_number_1`查找与模式匹配的内容。 
    
- 从关键字`Keywords_belgium_eu_telephone_number`找到。 
    
在 300 个字符的相似度内，如果出现以下情况，DLP 策略 75% 确信它检测到这种类型的敏感信息：
  
- 正则表达式`Regex_belgium_eu_telephone_number_2`查找与模式匹配的内容。 
...
- 正则表达式`Regex_bulgaria_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_bulgaria_eu_telephone_number`找到。 
...
- 正则表达式`Regex_croatia_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_croatia_eu_telephone_number`找到。 
...
- 正则表达式`Regex_cyprus_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_cyprus_eu_telephone_number`找到。 
...
- 正则表达式`Regex_czech_republic_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_czech_republic_eu_telephone_number`找到。 
...
- 正则表达式`Regex_denmark_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_denmark_eu_telephone_number`找到。 
...
- 正则表达式`Regex_estonia_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_estonia_eu_telephone_number`找到。 
...
- 正则表达式`Regex_finland_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_finland_eu_telephone_number`找到。 
...
- 正则表达式`Regex_france_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_france_eu_telephone_number`找到。 
...
- 正则表达式`Regex_germany_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_germany_eu_telephone_number`找到。 
...
- 正则表达式`Regex_greece_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_greece_eu_telephone_number`找到。 
...
- 正则表达式`Regex_hungary_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_hungary_eu_telephone_number`找到。 
...
- 正则表达式`Regex_ireland_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_ireland_eu_telephone_number`找到。 
...
- 正则表达式`Regex_italy_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_italy_eu_telephone_number`找到。 
...
- 正则表达式`Regex_latvia_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_latvia_eu_telephone_number`找到。 
...
- 正则表达式`Regex_lithuania_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_lithuania_eu_telephone_number`找到。 
...
- 正则表达式`Regex_luxemburg_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_luxemburg_eu_telephone_number`找到。 
...
- 正则表达式`Regex_malta_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_malta_eu_telephone_number`找到。 
...
- 正则表达式`Regex_netherlands_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_netherlands_eu_telephone_number`找到。 
...
- 正则表达式`Regex_poland_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_poland_eu_telephone_number`找到。 
...
- 正则表达式`Regex_portugal_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_portugal_eu_telephone_number`找到。 
...
- 正则表达式`Regex_romania_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_romania_eu_telephone_number`找到。 
...
- 正则表达式`Regex_slovakia_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_slovakia_eu_telephone_number`找到。 
...
- 正则表达式`Regex_slovenia_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_slovenia_eu_telephone_number`找到。 
...
- 正则表达式`Regex_spain_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_spain_eu_telephone_number`找到。 
...
- 正则表达式`Regex_sweden_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_sweden_eu_telephone_number`找到。 
...
- 正则表达式`Regex_uk_eu_telephone_number`查找与模式匹配的内容。 
    
- 从关键字`Keywords_uk_eu_telephone_number`找到。 
