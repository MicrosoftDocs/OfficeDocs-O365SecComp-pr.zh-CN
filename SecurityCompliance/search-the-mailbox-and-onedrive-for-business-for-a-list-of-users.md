...
- **您的用户凭据**-脚本将使用您的凭据访问 SharePoint Online, 以获取 OneDrive for business url, 并使用远程 PowerShell 连接&amp;到安全合规性中心。 
...
5. 当脚本提示时, 请输入以下信息。键入每条信息, 然后按**enter**。
    ...
    此脚本获取每个 OneDrive for business 网站的 url, 然后创建并启动搜索。可以在 security & 合规性中心 PowerShell 中运行**new-compliancesearch** cmdlet 以显示搜索统计信息和结果, 也可以转到安全&amp;合规中心中的 "**内容搜索**" 页以查看有关搜索的信息。 
