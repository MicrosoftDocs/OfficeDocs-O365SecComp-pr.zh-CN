...
[Office 365 Security _AMP_ 合规中心](https://protection.office.com)、 [Microsoft 365 安全中心](https://security.microsoft.com)和[microsoft 365 合规性中心](https://compliance.microsoft.com)是用于保护组织中的数据的一站式门户, 其中包括许多审核和报告提供. 这些中心可帮助你解决数据保护或合规性需求, 并审核用户和管理员活动。 您可以使用订阅管理员帐户访问这些中心。
